...
(function defineClassSkillMaster() {
  const classPlans = {
    ace: { type: "attack", rangeType: "short", target: "enemy_single", names: ["Command Slash", "Cross Order", "Blade Lead", "Duel Step", "Vanguard Edge", "Tactical Break", "Noble Guard", "Assault Command", "Silver Line", "Knight Drive", "Rally Edge", "Counter Order", "Frontline Burst", "Saber Dance", "Ace Directive", "Command Cyclone", "Flamberge Memory", "Limit Order", "Ark Break", "Last Commander"] },
